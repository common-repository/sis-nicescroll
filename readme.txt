...
Nicescroll is a jquery plugin for WordPress site. This plugin will create a nice scrollbar for your site only. Currently it is possible to add only one scrollbar to your WordPress Front-end site.

After installing and Activating the plugin, go to WordPress Admin Dahsbord and then go to

`Settings >> Nicescroll`

Here you can change default settings. So change settings as you choice and see a nice scrollbar at you site front-end.
...
Do you have questions or issues with WordPress Nicescroll? [Ask for support here.](http://wordpress.org/support/plugin/sis-nicescroll)

== Screenshots ==
1. Screenshot of option page of WordPress Nicescroll
2. Screenshot of WordPress Nicescroll

== Changelog ==

= 1.2 =
* Fixed bug regarding scrollbar.
* Add some new features.

= 1.1 =
* A bug has been fixed to view plugin option page.
...
2. Some open source framework have been used. For detail [click here](http://areaaperta.com/nicescroll/)